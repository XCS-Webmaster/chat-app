...
const URL = 'https://chat-app-7437.onrender.com/healthcheck';
const INTERVAL = 60 * 1000;
const logs = [];

let currentStatus = null; // 'online' or 'offline'
...
app.get('/', (req, res) => {
  ...
  res.send(`
    ...
    <html>
      ...
      <body>
        <img src="/logo.png" alt="XPRESS Logo" class="logo" />
